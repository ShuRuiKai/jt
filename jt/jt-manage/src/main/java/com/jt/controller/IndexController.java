...
public class IndexController {
	 ...
	 * 	 例子2:  http://www.jt.com/user?id=1    删除				DELETE(GET)
	...
	public String moduleName(@PathVariable(name = "moduleName") String moduleName) {
...
//	  @RequestMapping(value = "/user",method = RequestMethod.POST)
//	  @PostMapping("/user")   //GetMapping/PostMapping/PUTMapping
